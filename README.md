...
hugh_grant is a chat bot built on the [Hubot][hubot] framework. It was initially generated by [generator-hubot][generator-hubot], and configured to be deployed on [Heroku][heroku] to get you up and running as quick as possible.
...
### Running hugh_grant Locally

You can test your hubot by running the following.

You can start hugh_grant locally by running:
...
Then you can interact with hugh_grant by typing `hugh_grant help`.

    hugh_grant> hugh_grant help

    hugh_grant> animate me <query> - The same thing as `image me`, except adds a few
